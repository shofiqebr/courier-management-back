...
parcelRouter.get('/parcel', (0, auth_1.default)(['admin', 'agent']), parcel_controller_1.parcelController.getAllParcels);
parcelRouter.patch('/parcel/:id/status', (0, auth_1.default)(['agent']), (0, validateRequest_1.default)(parcel_validation_1.ParcelValidation.updateStatusSchema), parcel_controller_1.parcelController.updateStatus);
